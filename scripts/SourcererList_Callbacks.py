...
def onInitCell(comp, row, col, attribs):
	ext.SRCL.onInitCell(comp, row, col, attribs)
	return
def onInitRow(comp, row, attribs):
	ext.SRCL.onInitRow(comp, row, attribs)
	return
def onInitCol(comp, col, attribs):
	ext.SRCL.onInitCol(comp, col, attribs)
	return
def onInitTable(comp, attribs):
	ext.SRCL.onInitTable(comp, attribs)
	return
...
def onRollover(comp, row, col, coords, prevRow, prevCol, prevCoords):
	ext.SRCL.onRollover(comp, row, col, coords, prevRow, prevCol, prevCoords)
	return

def onSelect(comp, startRow, startCol, startCoords, endRow, endCol, endCoords, start, end):
	ext.SRCL.onSelect(comp, startRow, startCol, startCoords, endRow, endCol, endCoords, start, end)
	return

def onRadio(comp, row, col, prevRow, prevCol):
	ext.SRCL.onRadio(comp, row, col, prevRow, prevCol)
	return

def onFocus(comp, row, col, prevRow, prevCol):
	ext.SRCL.onFocus(comp, row, col, prevRow, prevCol)
	return

def onEdit(comp, row, col, val):
	ext.SRCL.onEdit(comp, row, col, val)
	return
